...
**hedwig-kg**는 소스 코드와 문서로부터 지식 그래프를 구축하고, 듀얼 임베딩 모델(코드 특화 + 자연어 특화)을 활용한 **6-시그널 HybridRAG 검색**을 RRF 융합으로 제공합니다. 모든 것이 **100% 로컬**에서 실행됩니다.
